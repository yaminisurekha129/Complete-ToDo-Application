...
return [
    ...
    */
    ...
    'guards' => [
        ...
        'api' => [
            'driver' => 'jwt', // Ensure you're using `jwt` for JSON Web Tokens
            'provider' => 'users',
        ],
    ],
    ...
    */
    ...
    'providers' => [
        'users' => [
            'driver' => 'eloquent', // Using Eloquent ORM to retrieve users
            'model' => App\Models\User::class,
        ],

        // Uncomment this if using a database provider:
        // 'users' => [
        //     'driver' => 'database',
        //     'table' => 'users',
        // ],
    ...
    */
    ...
    'passwords' => [
        'users' => [
            'provider' => 'users',
            'table' => 'password_reset_tokens', // Laravel 9+ uses password_reset_tokens
            'expire' => 120,
            'throttle' => 120,
        ],
    ],
